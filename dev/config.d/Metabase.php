...
return [
    'Metabase' => [
        ...
        'config' => [
            'links' => [
                'painel-agentes' => [
                    'link' => env('METABASE_AGENT_PANEL', null), // dashboard dos agentes
                    'text' => 'Agentes Culturais',
                    'title' => 'Agentes Culturais',
                    'entity' => 'Agent'
                ],
                'painel-espacos' => [
                    'link' => env('METABASE_SPACE_PANEL', null), // dashboard dos espaços
                ...
                'painel-oportunidades' => [
                    'link' => env('METABASE_OPPORTUNITY_PANEL', null), //dashboard das oportunidade
